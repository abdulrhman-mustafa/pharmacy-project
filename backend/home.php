...
<html lang="en">
	<head>
        ...
        <!-- favicon -->
        <link rel="icon" href="../frontend/assets/images/Nav-logo.png" type="image/x-icon">
...
<body>
    ...
    <div class="sticky-cart">
        <li class="hide-from-mobile">
            <a class="cart-icon" href="../frontend/pages/cart.html">
    ...
    <header id="sticky">
        <div class="container">
            ...
            <div class="logo">
                <a href="home.php"><img src="../frontend/assets/images/Nav-logo.png" alt="logo"></a>
            </div>
            <nav>
                <ul>
    ...
    <div class="about" id="about">
        <div class="container">
            ...
            <div class="about-content">
                <div class="image">
                    <img src="../frontend/assets/images/about.jpeg" alt="about" />
                </div>
                <div class="text">
                    <p>
    ...
    <section class="products" id="products">
        <div class="container">
            ...
            <div class="box-holder">
                <div class="box" data-category="cosmetics"  data-id="1">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-1.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Mascara BioNike</h3>
                    </div>
                    <div class="rate">
                ...
                <div class="box" data-category="cosmetics"  data-id="2">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-2.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Kohl BioNike</h3>
                    </div>
                ...
                <div class="box" data-category="cosmetics" data-id="3">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-3.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="regular" data-id="4">
                    <div class="image">
                        <img src="../frontend/assets/images/malox plus.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Maalox Plus</h3>
                    </div>
                ...
                <div class="box" data-category="regular" data-id="5">
                    <div class="image">
                        <img src="../frontend/assets/images/brufen.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Bruffen 600</h3>
                    </div>
                ...
                <div class="box" data-category="regular" data-id="6">
                    <div class="image">
                        <img src="../frontend/assets/images/strepsils.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="controlled" data-id="7">
                    <div class="image">
                        <img src="../frontend/assets/images/trittico.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="controlled" data-id="8">
                    <div class="image">
                        <img src="../frontend/assets/images/xigduo.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="controlled" data-id="9">
                    <div class="image">
                        <img src="../frontend/assets/images/pantoloc.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="cosmetics" data-id="10">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-4.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="cosmetics" data-id="11">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-5.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="cosmetics" data-id="12">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-6.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="regular" data-id="13">
                    <div class="image">
                        <img src="../frontend/assets/images/mixtrad.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Mixtard 30</h3>
                    </div>
                ...
                <div class="box" data-category="regular" data-id="14">
                    <div class="image">
                        <img src="../frontend/assets/images/panadol.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Panadol Extra</h3>
                    </div>
                ...
                <div class="box" data-category="regular" data-id="15">
                    <div class="image">
                        <img src="../frontend/assets/images/pas-c&f.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="controlled" data-id="16">
                    <div class="image">
                        <img src="../frontend/assets/images/L-c.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>L-Carnitine</h3>
                    </div>
                ...
                <div class="box" data-category="controlled" data-id="17">
                    <div class="image">
                        <img src="../frontend/assets/images/alzmenda.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>alzmenda</h3>
                    </div>
                ...
                <div class="box" data-category="controlled" data-id="18">
                    <div class="image">
                        <img src="../frontend/assets/images/apex.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Apexidonea</h3>
                    </div>
                ...
                <div class="box" data-category="cosmetics" data-id="19">
                    <div class="image">
                        <img src="../frontend/assets/images/cos-7.jpg " alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Dago Shampoo</h3>
                    </div>
                ...
                <div class="box" data-category="cosmetics" data-id="20"> 
                    <div class="image">
                        <img src="../frontend/assets/images/cos-8.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Foundation Collagra</h3>
                    </div>
                    <div class="rate">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                ...
                <div class="box" data-category="regular" data-id="21">
                    <div class="image">
                        <img src="../frontend/assets/images/otrivin1.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="regular" data-id="22">
                    <div class="image">
                        <img src="../frontend/assets/images/otrivin2.jpg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="box" data-category="controlled"data-id="23"> 
                    <div class="image">
                        <img src="../frontend/assets/images/nolvadex.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Nolvadex</h3>
                    </div>
                ...
                <div class="box" data-category="controlled" data-id="24">
                    <div class="image">
                        <img src="../frontend/assets/images/asmakast.jpg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Asmakast</h3>
                    </div>
    ...
    <section class="news" id="news">
        <div class="container">
            ...
            <div class="cards">
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med11.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med13.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med9.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med8.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Keto + AC</h3>
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med7.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Hagad Defend</h3>
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med6.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>The purpler Magic</h3>
                        <p>These supplements aim to support brain health, improve mental clarity, and boost focus.</p>
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med5.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Body Magic</h3>
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med4.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Omega-3</h3>
                        <p>fatty acids are healthy fats that support your brain, heart, and joints. They reduce inflammation and are found in foods like fish, flaxseeds, and walnuts.</p>
                ...
                <div class="card">
                    <div class="image">
                        <img src="../frontend/assets/images/med3.jpeg" alt="box1" />
                    </div>
                    <div class="info">
                        <h3>Vitamen E</h3>
    ...
    <footer>
        <div class="container">
            ...
            <p>We are working 24 / 7 , and we care about your safety.  </p>
            <div class="icons">
